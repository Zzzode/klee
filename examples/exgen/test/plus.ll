...
define dso_local i32 @plus() #0 !dbg !15 {
  call void @klee_make_symbolic(i8* bitcast (i32* @a to i8*), i64 4, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0))
  call void @klee_make_symbolic(i8* bitcast (i32* @b to i8*), i64 4, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.1, i64 0, i64 0))
