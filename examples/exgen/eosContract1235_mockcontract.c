...
#include "./eosContract1235_mockcontract.h"
...
static void init_func_types(void) {
  func_types[0] = wasm_rt_register_func_type(1, 0, WASM_RT_I64);
  func_types[1] = wasm_rt_register_func_type(0, 0);
  func_types[2] = wasm_rt_register_func_type(3, 0, WASM_RT_I64, WASM_RT_I64, WASM_RT_I64);
}
...
static void init_table(void) {
  uint32_t offset;
  wasm_rt_allocate_table((&__indirect_function_table), 1, 1);
}
...
/* export: 'init' */
void (*WASM_RT_ADD_PREFIX(Z_initZ_vv))(void);
/* export: 'apply' */
...
static void init_exports(void) {
  ...
  /* export: 'init' */
  WASM_RT_ADD_PREFIX(Z_initZ_vv) = (&init_0);
  /* export: 'apply' */
